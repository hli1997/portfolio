    ...
    <section id="projects" className="pt-48 pb-48">
      ...
      <div className="flex justify-center">
        ...
        >
          ...
          {/* ROW 2 */}
          <Project details={{title:"Project 3", description:"A Premier League dashboard application using Spring Boot and React, allowing users to browse teams and view previous match details."}}/>
